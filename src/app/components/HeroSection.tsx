...
function HeroSection() {
  return (
    <div
      className="h-auto md:h-[40rem] w-ful rounded-md flex flex-col items-center
    ...
    >
      ...
      <div className="p-4 relative z-10 w-full text-center">
        ...
        >
          Dive into aur comprehensive music courses and transform your music
          journey today. Whether you'r a beginner or looking to refine your
